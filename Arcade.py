...
games = {"snake":"Games\\Snake.py",
         "flappybird":"Games\\Flappy.py",
         "pong":"Games\\Pong.py",
         "pacman":"Games\\Pacman.py"}
s_img = pygame.image.load("Games\\sprites\\snake-img.png")
s_img = pygame.transform.smoothscale(s_img,(150,150))
fb_img = pygame.image.load("Games\\sprites\\flappybird-img.png")
fb_img = pygame.transform.smoothscale(fb_img,(150,150))
pn_img = pygame.image.load("Games\\sprites\\pong-img.png")
pn_img = pygame.transform.smoothscale(pn_img,(150,150))
pn1_img = pygame.image.load("Games\\sprites\\pong1-img.png")
pn1_img = pygame.transform.smoothscale(pn1_img,(150,150))
pc_img = pygame.image.load("Games\\sprites\\pacman-img.png")
pc_img = pygame.transform.smoothscale(pc_img, (120,120))
hm_img = pygame.image.load("Games\\sprites\\home.png")
hm_img = pygame.transform.smoothscale(hm_img,(40,40))
bg_img = pygame.image.load("Games\\sprites\\bg.png")
bg_img = pygame.transform.smoothscale(bg_img,(800,600))
side_img = pygame.image.load("Games\\sprites\\sidepanel.jpg")
